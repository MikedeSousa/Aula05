	...
	public static void main(String[] args) {
		...
		while(opcao!=4) {
			...
			case 1:
				...
				System.out.println("Por favor, digite o valor da hora-aula praticado na instituição");
			...
			case 3:
				...
				case 0:
				System.out.println("Que seus alunos sempre se sintam bem para tirarem dúvidas!");
				break;
				case 1:
